/**
 * Functionality of the calendar that was taken from the internet and not sure of it works
 * Was really hard to customize and takes local data.
 * WAS NOT ONE OF THE MAIN TASKS FOR OUR APP, SCRAPPED
 */
